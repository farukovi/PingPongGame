...
public class prio extends JPanel implements  KeyListener,ActionListener
{
	public field f;
	public int r,s;
	public int x=218,y=218,xx=340,yy=240,wid=3,len=3;
	Timer t = new Timer(5,this);
	public String c,d;
	public prio(String p, String q,int pp, int qq)
	{
		t.start();
		addKeyListener(this);
		setFocusable(true);
